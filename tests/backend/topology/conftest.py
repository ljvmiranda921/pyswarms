...
def swarm():
    ...
    return Swarm(
        position = np.array([
            [40.95838686e-01, 5.87433429e-04, 6.49113772e-03],
        ...
        velocity = np.array([
            [2.09076818e-02, 2.04936403e-03, 1.06761248e-02],
        ...
        current_cost = np.array([1.07818462, 5.5647911, 19.6046078, 14.05300016, 3.72597614, 1.01169386, 16.51846203, 32.72262829, 3.80274901, 1.05237138]),
        pbest_cost = np.array([1.00362006, 2.39151041, 2.55208424, 5.00176207, 1.04510827, 1.00025284, 6.31216654, 2.53873121, 2.00530884, 1.05237138]),
        pbest_pos = np.array([
